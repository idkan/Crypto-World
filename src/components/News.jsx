                ...
                <div className={"flex flex-col flex-grow bg-white mt-4 p-2 " + containerClasses} >
                    <div className="grid mb-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6">
                        {cryptoNews.value.map((news, i) => (
                            <a href={news.url} target='_blank' rel="noreferrer" tabIndex="0" className="rounded-3xl border shadow-md hover:shadow-lg focus:outline-none" aria-label={"New " + i} key={i}>
                                ...
                                <div className="bg-white px-4 py-4 rounded-bl-3xl rounded-br-3xl">
                                    ...
                                    <p tabIndex="0" className="focus:outline-none text-gray-700 text-base lg:leading-8 mt-6 w-full">{news.description}</p>
                                </div>
                            </a>
                        ))}
                    </div>
